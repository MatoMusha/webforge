---
name: design-system
description: Shared design knowledge library for webflo agents. Not user-invocable — referenced by director, builder, and future agents for typography, color, spatial, motion, interaction, responsive, and writing decisions.
user_invocable: false
---

# Design System Knowledge

This skill contains the design knowledge that webflo agents reference when making aesthetic and implementation decisions. It distills production-grade frontend design principles into actionable guidance.
